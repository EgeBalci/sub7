...
uses
  ...
  ExtCtrls, StdCtrls, TFlatSpeedButtonUnit, OutlookBtn, TB97Ctls, ImgList;
...
procedure TmsnForm.WMNCHitText(var Msg:TWMNCHitTest);
const Corner=5;
      OffSet=3;
begin
  inherited;
...
procedure TmsnForm.SetTheColors;
begin
 ...
 Label1.Font.Color:=cFormText;CuCine.Font.Color:=cFormText;CuCine.Color:=cFormForeground;
 Memo1.Color:=cFormForeground;
 Memo1.Font.Color:=cFormText;
 ToolbarButton971.Color:=cFormForeground;
 Invalidate; 
end;
...
procedure TmsnForm.CloseButtonClick(Sender: TObject);
begin
 Hide;
end;

procedure TmsnForm.CaptionLabelMouseDown(Sender: TObject;
...
procedure TmsnForm.CaptionLabelMouseMove(Sender: TObject; Shift: TShiftState;
  X, Y: Integer);
begin
...
procedure TmsnForm.CaptionLabelMouseUp(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
begin
if Capturing then with CaptionLabel.Parent do begin
 ReleaseCapture;
