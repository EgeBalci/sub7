...
begin
  ...
  CalcButtonLayout(Canvas, ClientRect, Offset, blGlyphBottom, FSpacing,
  ...
  begin
    ...
    case FNumGlyphs of
      ...
      2: case FState of
           ...
           bsDown:      sourceRect := Rect(FGlyph.Width div FNumGlyphs, 0, FGlyph.Width, FGlyph.Height);
      ...
      3: case FState of
           ...
           bsExclusive: SourceRect := Rect(FGlyph.width div FNumGlyphs, 0, (FGlyph.Width div FNumGlyphs) * 2, FGlyph.Height);
         end;
      4: case FState of
           bsUp:        SourceRect := Rect(0, 0, FGlyph.Width div FNumGlyphs, FGlyph.Height);
           bsDisabled:  SourceRect := Rect(FGlyph.width div FNumGlyphs, 0, (FGlyph.Width div FNumGlyphs) * 2, FGlyph.Height);
